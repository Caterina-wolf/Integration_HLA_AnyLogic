...
@Service
public class HLAServiceImpl extends NullFederateAmbassador implements HLAService {
    /**
     ...
     */
    public void start(String localSettingsDesignator, String federationName, String federateName, URL urlFOM) throws RTIinternalError, ConnectionFailed, NotConnected {
    ...
    public void join(String federateName) {
        try {
            boolean joined = false;
            while (!joined) {
                try {
                    ambassador.joinFederationExecution(federateName, "Manager", federationName);
                    joined = true;
                } catch (FederateNameAlreadyInUse | RestoreInProgress | NotConnected | RTIinternalError | SaveInProgress e) {
