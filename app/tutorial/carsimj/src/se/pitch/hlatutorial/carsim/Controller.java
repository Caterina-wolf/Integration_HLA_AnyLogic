 ...
 */
package carsimj.src.se.pitch.hlatutorial.carsim;

import hla.rti1516e.exceptions.RTIexception;
import carsimj.src.se.pitch.hlatutorial.carsim.carsimulator.CarSimulator;
import carsimj.src.se.pitch.hlatutorial.carsim.hlamodule.HlaInterface;
import carsimj.src.se.pitch.hlatutorial.carsim.hlamodule.InteractionListener;
import carsimj.src.se.pitch.hlatutorial.carsim.model.Car;
import carsimj.src.se.pitch.hlatutorial.carsim.model.Position;
...
public class Controller {
   ...
   public void start() {
      try {
         _config = new SimulationConfig("C:\\temp\\Simulation.config");
      } catch (IOException e) {
